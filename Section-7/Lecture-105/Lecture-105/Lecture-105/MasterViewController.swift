...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyCsM7vkFNs2o6J1gvIYVCJnRbMo4vbYi7I")!
        ...
        let task = session.dataTaskWithURL(url) { (data, response, error) -> Void in
            ...
            if error != nil {
                ...
                print("Some JSON Serialization error: \(error?.localizedDescription)")
